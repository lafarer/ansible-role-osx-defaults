...
```
ApplicationFirewall_Enabled: false               # Enable Application Firewall
...
DesktopScreenSaver_askForPassword: false         # Require password after sleep or screen saver begins
```
...
```
LoginWindow_Enabled: false                       # Enable Launch Services configuration
LoginWindow_DisableConsoleAccess: false          # Toggle login for hidden user '>Console'
LoginWindow_GuestEnabled: false                  # Toggle guest login
...
LoginWindow_ShutDownDisabled: false              # Disable shutdown and restart button on login Window
LoginWindow_showInputMenu: false                 # Show input menu in login window
